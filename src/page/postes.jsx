...
// ── Carte Mobile (avec seulement bouton Accéder) ──────────
...
// ── Page Offres (version simplifiée sans CRUD) ────────────
        ...
        <main className={`main-content ${sidebarOpen ? "main-content--shifted" : ""}`}>
          <div className="offres-page">
            ...
            <div className="offres-breadcrumb">
              ...
              <p><Link to="/acceuil">Bienvenue solibra</Link>{" / "}Listes des postes</p>
            </div>
            ...
            <div className="offres-card" ref={tableRef}>
              <div className="offres-toolbar">
                ...
                {/* Le bouton "Ajouter une offre" a été SUPPRIMÉ */}
              </div>

              {/* ── TABLE desktop (sans actions CRUD) ── */}
